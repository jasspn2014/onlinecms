...
<div class="container_form">
    <form method="post">
				<div class="teacher_name_pos">
					<input type="text" name="fnametxt" class="form-control" value="<?php echo $row['f_name'];?>" />
					<input type="text" name="lnametxt" class="form-control" value="<?php echo $row['f_name'];?>" />
				</div><br>

				<div class="teacher_radio_pos">
					<input type="radio" name="genderrdo" value="Male"<?php if($row['gender']=="Male") echo "checked";?> /> <span class="p_font">&nbsp;Male</span>
					<input type="radio" name="genderrdo" value="Female"<?php if($row['gender']=="Female") echo "checked";?> /> <span class="p_font">&nbsp;Female</span>
				</div><br>
				...
				<div class="teacher_bdayPlace_pos">
					<input type="text" name="pobtxt" class="form-control" value=" <?php echo $row['pob']; ?>" />
				</div><br>

				<div class="teacher_address_pos">
					<input type="text" name="addrtxt" class="form-control" value=" <?php echo $row['address'];?>" />
				</div><br>
				...
				<div class="teacher_salary_pos">
					<input type="text" name="slarytxt" class="form-control" value="<?php echo $row['salary'];?>" />
				</div><br>

				<div class="teacher_married_pos">
					<span class="p_font">Married</span>
					<input type="radio" name="marriedrdo" value="Yes"<?php if($row['married']=="Yes") echo "checked";?> /> <span class="p_font">&nbsp;Yes</span>
					<input type="radio" name="marriedrdo" value="No"<?php if($row['married']=="No") echo "checked";?> /> <span class="p_font">&nbsp;No</span>
				</div><br>

				<div class="teacher_mobile_pos">
					<input type="text" name="phonetxt" class="form-control" value="<?php echo $row['phone'];?>" />
				</div><br>

				<div class="teacher_mail_pos">
					<input type="text" name="emailtxt" class="form-control" value="<?php echo $row['email'];?>" />
				</div><br>

				<div class="teacher_note_pos">
					<input type="text" name="notetxt" class="form-control" value="<?php echo $row['note'];?>" />
				</div><br>
