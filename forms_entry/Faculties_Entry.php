...
if($opr=="upd")
{
	$sql = "SELECT * FROM facuties_tbl WHERE faculties_id=$id";
...
<div class="container_form">
    <form method="post">
        <div class='faculty_pos'>
            ...
            <input type="text" style="width: 250px;" class="form-control" name="fnametxt" value="<?php echo $row['faculties_name'];?>"/><br>

            <textarea name="notetxt" class="form-control" cols="18" value='<?php  echo $row['note'];?>' rows="4"></textarea><br><Br>
