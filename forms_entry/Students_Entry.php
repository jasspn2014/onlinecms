...
if($opr=="upd")
{
	$sql = "SELECT * FROM stu_tbl WHERE stu_id=$id";
...
<div class="panel panel-default">
    ...
    <form method="post">
				<div class="teacher_name_pos">
					...
					<input type="text" name="lnametxt" class="form-control" value="<?php echo $row['l_name'];?>" />
				</div><br>

				<div class="teacher_radio_pos">
					<input type="radio" name="gender" value="Male" <?php if($row['gender']=="Male") echo "checked";?> /> <span class="p_font">&nbsp;Male</span>
					<input type="radio" name="gender" value="Female" <?php if($row['gender']=="Female") echo "checked";?> /> <span class="p_font">&nbsp;Female</span>
				</div><br>
